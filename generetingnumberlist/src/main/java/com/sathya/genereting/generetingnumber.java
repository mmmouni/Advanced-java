...
public class generetingnumber extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
{
		    ...
		    private void processRequest(PrintWriter writer, int start, int end, String category) {
		        switch (category.toLowerCase()) {
		            ...
		            case "perfect":
		            	...
		            	break;
		            case "amstrong":
		            	getAmstrongNumber(writer,start,end);
		            	break;
		    ...
		    private void getAmstrongNumber(PrintWriter writer, int start, int end) {
		        for (int i = start; i <= end; i++) {
		            if (isArmstrong(i)) {
		                writer.println(i + " ");
		            }
